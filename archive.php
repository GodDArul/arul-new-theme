 ...
 *
 * Digunakan untuk menampilkan daftar postingan berdasarkan kategori, tag, penulis, tanggal, atau jenis arsip lainnya.
 *
 * @link https://developer.wordpress.org/themes/basics/template-files/#archive
 *
...
<main id="primary" class="site-main">
    <div class="container">
        <header class="page-header">
            <?php
            // Menampilkan judul arsip (misal: "Arsip Kategori: Teknologi", "Arsip Tag: WordPress")
            the_archive_title( '<h1 class="page-title">', '</h1>' );
            // Menampilkan deskripsi arsip jika ada
